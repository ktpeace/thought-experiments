...
const experimentData: Record<string, ExperimentData> = {
  ...
  "life-you-can-save": {
    ...
    description: [
      ...
      `If you don't wade in and rescue him, he seems likely to drown. Saving him would be safe and easy, but your new shoes and pants would get wet and muddy. You might even miss your train and be late for work. What should you do...`,
      `HOLD UP! The true question is not whether you should help the child, to which nearly everyone says yes.`,
      `Every day on Earth, people who are doing OK spend money on non-essential items, while some are suffering and dying in far worse conditions.`,
    ],
